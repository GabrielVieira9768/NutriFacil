...
<div class="d-flex justify-content-center my-5 secao-principal text-center">
    ...
    <img class="imagem-principal rounded"
         src="/public/assets/logo-name.png"
         alt="Logo da NutriFácil">

    <div class="slogan d-flex align-items-center mb-5">
        <div>
            <h1 class="titulo-principal">NutriFácil</h1>
            <p>
                Promovendo hábitos alimentares saudáveis e educação nutricional.
                Descubra dicas práticas e receitas para uma vida equilibrada!
            </p>
        </div>
    </div>
...
<div class="mb-5 secao-publicacoes">
    ...
    <div class="d-flex justify-content-center mb-4">
        <h2 class="title-publicacoes">Publicações Recentes</h2>
    </div>
        ...
        <?php foreach (array_slice($posts, 0, 4) as $post) : ?>
            ...
            <div class="card mx-3 mb-3 card-post">
                ...
                <img src="/<?= htmlspecialchars($post->image) ?>"
                     ...
                     alt="<?= htmlspecialchars($post->image_alt ?? 'Imagem do post') ?>">
                ...
                <div class="card-body rounded d-flex flex-column justify-content-between">
                    ...
                    <div class="d-flex flex-column align-items-center mt-auto">
                        ...
                        <a href="/post/<?= $post->id ?>"
                           class="btn d-flex align-items-center botao-index"
                           title="Acessar postagem completa">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg"
                                 ...
                                 width="24px"
                                 fill="white">
                                <path d="M400-400h160v-80H400v80Zm0-120h320v-80H400v80Zm0-120h320v-80H400v80Zm-80 400q-33 0-56.5-23.5T240-320v-480q0-33 23.5-56.5T320-880h480q33 0 56.5 23.5T880-800v480q0 33-23.5 56.5T800-240H320Zm0-80h480v-480H320v480ZM160-80q-33 0-56.5-23.5T80-160v-560h80v560h560v80H160Z"/>
                            </svg>

                            <span class="span-text ms-2">
                                Post Completo
                            </span>
    ...
    <div class="d-flex justify-content-center m-5 secao-sobre">
        ...
        <div class="slogan d-flex align-items-center">
            ...
            <img style="max-width: 460px;"
                 src="/public/assets/sobre-image.png"
