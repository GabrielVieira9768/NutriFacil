        ...
        <div class="d-flex justify-content-between">
            <div class="col-md-3 mb-3">
                <form action="/posts/busca" method="GET" class="input-group">
                    ...
                    <button class="btn search-botao" type="submit" id="button-pesquisa" title="Pesquisar posts">
            ...
            <div>
                <button type="button" class="btn d-flex align-items-center botao" title="Adicionar Novo Post" data-bs-toggle="modal" data-bs-target="#modal-adicionar">
                    <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="white">
                        <path d="M720-400v-120H600v-80h120v-120h80v120h120v80H800v120h-80Zm-360-80q-66 0-113-47t-47-113q0-66 47-113t113-47q66 0 113 47t47 113q0 66-47 113t-113 47ZM40-160v-112q0-34 17.5-62.5T104-378q62-31 126-46.5T360-440q66 0 130 15.5T616-378q29 15 46.5 43.5T680-272v112H40Zm80-80h480v-32q0-11-5.5-20T580-306q-54-27-109-40.5T360-360q-56 0-111 13.5T140-306q-9 5-14.5 14t-5.5 20v32Zm240-320q33 0 56.5-23.5T440-640q0-33-23.5-56.5T360-720q-33 0-56.5 23.5T280-640q0 33 23.5 56.5T360-560Zm0-80Zm0 400Z" />
                    </svg>
                    <span class="span-text">Novo Post</span>
                </button>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex justify-content-center flex-wrap">
                                <div class="mx-2">
                                    <button type="button" class="btn botao" title="Visualizar Postagem" data-bs-toggle="modal" data-bs-target="#modal-show-<?php echo $post->id; ?>">
                                        <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="white">
                                            <path d="M480-320q75 0 127.5-52.5T660-500q0-75-52.5-127.5T480-680q-75 0-127.5 52.5T300-500q0 75 52.5 127.5T480-320Zm0-72q-45 0-76.5-31.5T372-500q0-45 31.5-76.5T480-608q45 0 76.5 31.5T588-500q0 45-31.5 76.5T480-392Zm0 192q-146 0-266-81.5T40-500q54-137 174-218.5T480-800q146 0 266 81.5T920-500q-54 137-174 218.5T480-200Zm0-300Zm0 220q113 0 207.5-59.5T832-500q-50-101-144.5-160.5T480-720q-113 0-207.5 59.5T128-500q50 101 144.5 160.5T480-280Z" />
                                        </svg>
                                    </button>
                                    <?php require('app/views/components/modal/posts/show.php'); ?>
                                </div>
                                <div class="mx-2">
                                    <button type="button" class="btn botao" title="Editar Postagem" data-bs-toggle="modal" data-bs-target="#modal-update-<?php echo $post->id; ?>">
                                        <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="white">
                                            <path d="M200-200h57l391-391-57-57-391 391v57Zm-80 80v-170l528-527q12-11 26.5-17t30.5-6q16 0 31 6t26 18l55 56q12 11 17.5 26t5.5 30q0 16-5.5 30.5T817-647L290-120H120Zm640-584-56-56 56 56Zm-141 85-28-29 57 57-29-28Z" />
                                        </svg>
                                    </button>
                                    <?php require('app/views/components/modal/posts/update.php'); ?>
                                </div>
                                <div class="mx-2">
                                    <button type="button" class="btn botao" title="Deletar Postagem" data-bs-toggle="modal" data-bs-target="#modal-delete-<?php echo $post->id; ?>">
                                        <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="white">
                                            <path d="M280-120q-33 0-56.5-23.5T200-200v-520h-40v-80h200v-40h240v40h200v80h-40v520q0 33-23.5 56.5T680-120H280Zm400-600H280v520h400v-520ZM360-280h80v-360h-80v360Zm160 0h80v-360h-80v360ZM280-720v520-520Z" />
                                        </svg>
                                    </button>
                                    <?php require('app/views/components/modal/posts/delete.php'); ?>
                                </div>
                            </div>
                        </td>
                    </tr>
